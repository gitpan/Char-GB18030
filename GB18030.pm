...
# functions of package Egb18030
    ...
    elsif (m{\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) }oxgc) { $slash = 'm//'; return 'Egb18030::fc';           }
    ...
    elsif (m{\G \b fc \b         (?! \s* => )                         }oxgc) { $slash = 'm//'; return 'Egb18030::fc_';               }
    elsif (m{\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
...
# functions of package Egb18030
        ...
        elsif ($string =~ m{\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) }oxgc) { $e_string .= 'Egb18030::fc';      $slash = 'm//'; }
        ...
        elsif ($string =~ m{\G \b fc \b                                              }oxgc) { $e_string .= 'Egb18030::fc_';               $slash = 'm//'; }
        elsif ($string =~ m{\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ m/\A [\x00-\xFF] \z/oxms) and (Egb18030::uc($char[$i]) ne Egb18030::fc($char[$i]))) {
...
=item * Length By GB18030 Character
  ...
  the scalar value $string. If $string is omitted, it returns the GB18030::length of
  $_.
...
=item * Rindex By GB18030 Character
  ...
  This function works just like GB18030::index except that it returns the character
