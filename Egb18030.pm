...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Egb18030::binmode(FILEHANDLE, $disciplines);
  Egb18030::binmode(FILEHANDLE);
  Egb18030::binmode($filehandle, $disciplines);
  Egb18030::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Egb18030::open(FILEHANDLE, $mode, $expr);
  $rc = Egb18030::open(FILEHANDLE, $expr);
  $rc = Egb18030::open(FILEHANDLE);
  $rc = Egb18030::open(my $filehandle, $mode, $expr);
  $rc = Egb18030::open(my $filehandle, $expr);
  $rc = Egb18030::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Egb18030::open($fh, ">logfile")     # $fh is autovivified
  ...
  Egb18030::open my $fh, ">logfile" or die ...
  ...
  Egb18030::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Egb18030::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Egb18030::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Egb18030::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Egb18030::open(FH, "<:crlf:encoding(GB18030)", $path) or die "can't open $path: $!";
