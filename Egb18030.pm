...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $uc = Egb18030::uc($char)) ne $char) {
                $pattern .= $uc;
            }
            else {
...
This module is a run-time routines of the GB18030.pm.
Because the GB18030.pm automatically uses this module, you need not use directly.
...
=item Make character
  ...
  set. For example, Egb18030::chr(65) is "A" in either ASCII or GB18030, not Unicode,
  and Egb18030::chr(0x82a0) is a GB18030 HIRAGANA LETTER A. For the reverse of
  Egb18030::chr, use GB18030::ord.
...
=item File test operator -X
  ...
  Function and Prototype     Meaning
  ------------------------------------------------------------------------------
  Egb18030::s(*), Egb18030::s_()   File has nonzero size (returns size in bytes)
