...
This module is a run-time routines of the Char/GB18030.pm.
Because the Char/GB18030.pm automatically uses this module, you need not use directly.
...
=item Reverse index string
  ...
  This function works just like Char::Egb18030::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of GB18030 $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Egb18030::fc function for case-insensitive comparisons via Char::GB18030
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of GB18030 $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of GB18030 $string (or $_, if
...
=item Fold case string
  ...
  New to Char::GB18030 software, this function returns the full Unicode-like casefold of
  GB18030 $string (or $_, if omitted). This is the internal function implementing
...
=item File test function Char::Egb18030::X
...
=item Filename expansion (globbing)
  ...
  The Char::Egb18030::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Char::Egb18030::stat, Char::Egb18030::lstat, or Char::Egb18030::stat-based file test function
