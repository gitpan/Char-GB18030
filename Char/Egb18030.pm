...
BEGIN {
    ...
    sub Char::Egb18030::binmode(*;$);
    sub Char::Egb18030::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Egb18030::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Egb18030::open;
    }
}
...
=item Make character
  ...
  set. For example, Char::Egb18030::chr(65) is "A" in either ASCII or GB18030, and
  Char::Egb18030::chr(0x82a0) is a GB18030 HIRAGANA LETTER A. For the reverse of Char::Egb18030::chr,
  use Char::GB18030::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Egb18030::binmode(FILEHANDLE, $disciplines);
  Char::Egb18030::binmode(FILEHANDLE);
  Char::Egb18030::binmode($filehandle, $disciplines);
  Char::Egb18030::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Egb18030::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Egb18030::open(FILEHANDLE, $expr);
  $rc = Char::Egb18030::open(FILEHANDLE);
  $rc = Char::Egb18030::open(my $filehandle, $mode, $expr);
  $rc = Char::Egb18030::open(my $filehandle, $expr);
  $rc = Char::Egb18030::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Egb18030::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Egb18030::open my $fh, ">logfile" or die ...
  ...
  Char::Egb18030::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Egb18030::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Egb18030::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Egb18030::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Egb18030::open(FH, "<:crlf:encoding(Char::GB18030)", $path) or die "can't open $path: $!";
