...
# regexp of character
BEGIN { CORE::eval q{ use vars qw($your_char) } } $your_char = q{[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE][^\x30-\x39]|[\x00-\xFF]};
...
sub Char::Egb18030::index($$;$);
sub Char::Egb18030::rindex($$;$);
sub Char::Egb18030::lcfirst(@);
sub Char::Egb18030::lcfirst_();
sub Char::Egb18030::lc(@);
sub Char::Egb18030::lc_();
sub Char::Egb18030::ucfirst(@);
sub Char::Egb18030::ucfirst_();
sub Char::Egb18030::uc(@);
...
sub Char::Egb18030::o_();
sub Char::Egb18030::R_();
sub Char::Egb18030::W_();
sub Char::Egb18030::X_();
sub Char::Egb18030::O_();
sub Char::Egb18030::e_();
sub Char::Egb18030::z_();
sub Char::Egb18030::s_();
sub Char::Egb18030::f_();
sub Char::Egb18030::d_();
sub Char::Egb18030::l_();
sub Char::Egb18030::p_();
sub Char::Egb18030::S_();
sub Char::Egb18030::b_();
sub Char::Egb18030::c_();
sub Char::Egb18030::u_();
sub Char::Egb18030::g_();
sub Char::Egb18030::k_();
sub Char::Egb18030::T_();
sub Char::Egb18030::B_();
sub Char::Egb18030::M_();
sub Char::Egb18030::A_();
sub Char::Egb18030::C_();
sub Char::Egb18030::glob($);
sub Char::Egb18030::glob_();
sub Char::Egb18030::lstat(*);
sub Char::Egb18030::lstat_();
sub Char::Egb18030::opendir(*$);
sub Char::Egb18030::stat(*);
sub Char::Egb18030::stat_();
sub Char::Egb18030::unlink(@);
sub Char::Egb18030::chdir(;$);
sub Char::Egb18030::do($);
sub Char::Egb18030::require(;$);
sub Char::Egb18030::telldir(*);
...
sub Char::GB18030::rindex($$;$);
sub Char::GB18030::escape(;$);
...
${Char::Egb18030::anchor}      = qr{\G(?:[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE][^\x30-\x39]|[^\x81-\xFE])*?}oxms;
...
if (($] >= 5.010001) or
    ...
    # GB18030 encoding
        ...
        ${Char::Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[^\x30-\x39\x81-\xFE](?:[\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE]{2})*?}oxms;
    ...
    # other encoding
        ...
        ${Char::Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:$tbcs_1st[^$sbcs]{2})*?}oxms;
    }

    ${Char::Egb18030::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE][^\x30-\x39]|[^\x81-\xFE])*?|(?(?=[$sbcs]+\z).*?|(?:${Char::Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
#                          (?:[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE][^\x30-\x39]|[^\x81-\xFE])*?| # (5)
#                                                                                      (?(?=[$sbcs]+\z) # (6)
#                                                                                                      .*?| #(7)
#                                                                                                          (?:${Char::Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17}) # (8)
#                                                                                                                                                           ))}oxms;

    # avoid: Complex regular subexpression recursion limit (32766) exceeded at here.
    local $^W = 0;

    if (((('A' x 32768).'B') !~ / ${Char::Egb18030::anchor}                              B /oxms) and
        ((('A' x 32768).'B') =~ / ${Char::Egb18030::anchor_SADAHIRO_Tomoyuki_2002_01_17} B /oxms)
    ) {
        ${Char::Egb18030::anchor} = ${Char::Egb18030::anchor_SADAHIRO_Tomoyuki_2002_01_17};
    }
    else {
        undef ${Char::Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17};
    }
}
...
${Char::Egb18030::eS}          = qr{(?:[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE][^\x30-\x39]|[^\x81-\xFE\s])};
...
${Char::Egb18030::not_space}   = qr{(?:[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE][^\x30-\x39]|[^\x81-\xFE\s\x0B])};
...
# avoid: Name "Char::Egb18030::foo" used only once: possible typo at here.
${Char::Egb18030::dot}         = ${Char::Egb18030::dot};
${Char::Egb18030::dot_s}       = ${Char::Egb18030::dot_s};
${Char::Egb18030::eD}          = ${Char::Egb18030::eD};
${Char::Egb18030::eS}          = ${Char::Egb18030::eS};
${Char::Egb18030::eW}          = ${Char::Egb18030::eW};
${Char::Egb18030::eH}          = ${Char::Egb18030::eH};
${Char::Egb18030::eV}          = ${Char::Egb18030::eV};
${Char::Egb18030::eR}          = ${Char::Egb18030::eR};
${Char::Egb18030::eN}          = ${Char::Egb18030::eN};
${Char::Egb18030::not_alnum}   = ${Char::Egb18030::not_alnum};
${Char::Egb18030::not_alpha}   = ${Char::Egb18030::not_alpha};
${Char::Egb18030::not_ascii}   = ${Char::Egb18030::not_ascii};
${Char::Egb18030::not_blank}   = ${Char::Egb18030::not_blank};
${Char::Egb18030::not_cntrl}   = ${Char::Egb18030::not_cntrl};
${Char::Egb18030::not_digit}   = ${Char::Egb18030::not_digit};
${Char::Egb18030::not_graph}   = ${Char::Egb18030::not_graph};
${Char::Egb18030::not_lower}   = ${Char::Egb18030::not_lower};
${Char::Egb18030::not_lower_i} = ${Char::Egb18030::not_lower_i};
${Char::Egb18030::not_print}   = ${Char::Egb18030::not_print};
${Char::Egb18030::not_punct}   = ${Char::Egb18030::not_punct};
${Char::Egb18030::not_space}   = ${Char::Egb18030::not_space};
${Char::Egb18030::not_upper}   = ${Char::Egb18030::not_upper};
${Char::Egb18030::not_upper_i} = ${Char::Egb18030::not_upper_i};
${Char::Egb18030::not_word}    = ${Char::Egb18030::not_word};
${Char::Egb18030::not_xdigit}  = ${Char::Egb18030::not_xdigit};
${Char::Egb18030::eb}          = ${Char::Egb18030::eb};
${Char::Egb18030::eB}          = ${Char::Egb18030::eB};
...
sub Char::Egb18030::split(;$$$) {
    ...
    if (CORE::length($string) > 32766) {
        ...
        elsif (defined ${Char::Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17}) {
            $q_char = ${Char::Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17};
        }
    }
...
sub Char::Egb18030::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Egb18030::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Egb18030::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Egb18030::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Egb18030::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Egb18030::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Egb18030::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Egb18030::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
#
{
    ...
    sub Char::Egb18030::matched() {
        $last_s_matched = 0;
    }

    # GB18030 mark last s/// matched
    sub Char::Egb18030::s_matched() {
        $last_s_matched = 1;
    }
    ...
    $Char::Egb18030::matched = qr/(?{Char::Egb18030::matched})/;
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Egb18030::uc($char[$i]);
                my $fc = Char::Egb18030::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Egb18030::not_lower_i}',
                '[:^upper:]'  => '${Char::Egb18030::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Egb18030::not_alnum}',
                '[:^alpha:]'  => '${Char::Egb18030::not_alpha}',
                '[:^ascii:]'  => '${Char::Egb18030::not_ascii}',
                '[:^blank:]'  => '${Char::Egb18030::not_blank}',
                '[:^cntrl:]'  => '${Char::Egb18030::not_cntrl}',
                '[:^digit:]'  => '${Char::Egb18030::not_digit}',
                '[:^graph:]'  => '${Char::Egb18030::not_graph}',
                '[:^lower:]'  => '${Char::Egb18030::not_lower}',
                '[:^print:]'  => '${Char::Egb18030::not_print}',
                '[:^punct:]'  => '${Char::Egb18030::not_punct}',
                '[:^space:]'  => '${Char::Egb18030::not_space}',
                '[:^upper:]'  => '${Char::Egb18030::not_upper}',
                '[:^word:]'   => '${Char::Egb18030::not_word}',
                '[:^xdigit:]' => '${Char::Egb18030::not_xdigit}',
    ...
    for (@multipleoctet) {
        if (/\A ([\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE]) ([\x00-\xFF]) \z/oxms) {
            $_ = $1 . quotemeta $2;
        }
    }
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Egb18030::uc($char);
                        my $fc = Char::Egb18030::fc($char);
                        if ($uc eq $fc) {
...
sub Char::Egb18030::filetest {
    ...
    unless (CORE::eval qq{Char::Egb18030::$filetest(\$file)}) {
        return '';
    }
...
sub Char::Egb18030::r(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -r (Char::Egb18030::r)' if @_ and not wantarray;
...
sub Char::Egb18030::w(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -w (Char::Egb18030::w)' if @_ and not wantarray;
...
sub Char::Egb18030::x(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -x (Char::Egb18030::x)' if @_ and not wantarray;
...
sub Char::Egb18030::o(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -o (Char::Egb18030::o)' if @_ and not wantarray;
...
sub Char::Egb18030::e(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -e (Char::Egb18030::e)' if @_ and not wantarray;
    ...
    elsif (defined Char::Egb18030::telldir($fh)) {
        return wantarray ? ('',@_) : '';
    }
...
sub Char::Egb18030::z(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -z (Char::Egb18030::z)' if @_ and not wantarray;
...
sub Char::Egb18030::s(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -s (Char::Egb18030::s)' if @_ and not wantarray;
...
sub Char::Egb18030::f(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -f (Char::Egb18030::f)' if @_ and not wantarray;
...
sub Char::Egb18030::d(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -d (Char::Egb18030::d)' if @_ and not wantarray;
...
sub Char::Egb18030::l(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -l (Char::Egb18030::l)' if @_ and not wantarray;
...
sub Char::Egb18030::p(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -p (Char::Egb18030::p)' if @_ and not wantarray;
...
sub Char::Egb18030::b(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -b (Char::Egb18030::b)' if @_ and not wantarray;
...
sub Char::Egb18030::c(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -c (Char::Egb18030::c)' if @_ and not wantarray;
...
sub Char::Egb18030::u(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -u (Char::Egb18030::u)' if @_ and not wantarray;
...
sub Char::Egb18030::g(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -g (Char::Egb18030::g)' if @_ and not wantarray;
...
sub Char::Egb18030::k(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -k (Char::Egb18030::k)' if @_ and not wantarray;
...
sub Char::Egb18030::T(;*@) {
    ...
    #     croak 'Too many arguments for -T (Char::Egb18030::T)';
    ...
    if (defined fileno $fh) {
        ...
        if (defined Char::Egb18030::telldir($fh)) {
            return wantarray ? (undef,@_) : undef;
        }
...
sub Char::Egb18030::M(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -M (Char::Egb18030::M)' if @_ and not wantarray;
...
sub Char::Egb18030::A(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -A (Char::Egb18030::A)' if @_ and not wantarray;
...
sub Char::Egb18030::filetest_ {
    ...
    unless (CORE::eval qq{Char::Egb18030::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (CORE::eval qq{ $filetest _ }) {
...
OUTER:
    for my $expr (@expr) {
        ...
        if ($expr =~ /\A " ((?:$q_char)*) " \z/oxms) {
            $expr = $1;
            if ($cond eq 'd') {
                if (Char::Egb18030::d $expr) {
                    push @glob, $expr;
                }
            }
            else {
                if (Char::Egb18030::e $expr) {
                    push @glob, $expr;
                }
            }
            next OUTER;
        ...
        if ($expr !~ / \A (?:$q_char)*? [*?] /oxms) {
            ...
            $head .= $expr;
            if ($cond eq 'd') {
                if (Char::Egb18030::d $head) {
                    push @glob, $head;
                }
            }
            else {
                if (Char::Egb18030::e $head) {
                    push @glob, $head;
                }
            }
            next OUTER;
        }
        Char::Egb18030::opendir(*DIR, $head) or next OUTER;
        my @leaf = readdir DIR;
        closedir DIR;
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Egb18030::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Egb18030::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if ($cond eq 'd' and not Char::Egb18030::d "$head$leaf") {
                next INNER;
            }
            ...
            if (Char::Egb18030::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Egb18030::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub my_home {
    ...
    if (defined $home and ! Char::Egb18030::d($home)) {
        $home = undef;
    }
    return $home;
}
        ...
        # rejected idea ...
            ...
            if (($] =~ /^5\.006/oxms)                     and
                ...
                *{'Dyna'.'Loader::dl_install_xsub'}{'CODE'}->('_SetCurrentDirectoryA', unpack('L', pack 'P', $x86));
                ...
                if (Char::Egb18030::fc($chdir) eq Char::Egb18030::fc($dir)) {
                    return 1;
                }
                else {
                    return 0;
...
#   long filename form.
        ...
        if (qx{ver} =~ /\b(?:Windows NT|Windows 2000)\b/oms) {
            ...
            for my $dirx (sort { CORE::length($a) <=> CORE::length($b) } @dirx) {
                if (Char::Egb18030::fc(CORE::substr $dirx,-CORE::length($subdir[-1]),CORE::length($subdir[-1])) eq Char::Egb18030::fc($subdir[-1])) {
        ...
        elsif (Char::Egb18030::fc($shortdir) eq Char::Egb18030::fc($dir)) {
            return 0;
        }
        return CORE::chdir $shortdir;
    }
...
ITER_DO:
    {
        for my $prefix (@INC) {
            ...
            if (Char::Egb18030::f($realfilename)) {

                my $script = '';

                if (Char::Egb18030::e("$realfilename.e")) {
                    my $e_mtime      = (Char::Egb18030::stat("$realfilename.e"))[9];
                    my $mtime        = (Char::Egb18030::stat($realfilename))[9];
                    my $module_mtime = (Char::Egb18030::stat(__FILE__))[9];
                    if (($e_mtime < $mtime) or ($mtime < $module_mtime)) {
                        Char::Egb18030::unlink "$realfilename.e";
                    }
                }
                ...
                if (Char::Egb18030::e("$realfilename.e")) {
                    ...
                    if ($script =~ /^ \s* use \s+ Char::GB18030 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
...
sub Char::GB18030::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Egb18030::index($_[0], $_[1], CORE::length(Char::GB18030::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Egb18030::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::GB18030::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::GB18030::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Egb18030::rindex($_[0], $_[1], CORE::length(Char::GB18030::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Egb18030::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::GB18030::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::GB18030::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
my $matched     = '';
my $s_matched   = '';
$matched        = q{$Char::Egb18030::matched};
$s_matched      = q{ Char::Egb18030::s_matched();};
...
sub Char::GB18030::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::GB18030::escape_token();
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Egb18030::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Egb18030::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Egb18030::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Egb18030::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Egb18030::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Egb18030::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Egb18030::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Egb18030::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Egb18030::glob';
    }
...
# subroutines of package Char::Egb18030
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::GB18030::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::GB18030::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::GB18030::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Egb18030::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::GB18030::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::GB18030::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Egb18030::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::GB18030::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::GB18030::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Egb18030::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egb18030::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egb18030::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egb18030::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egb18030::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egb18030::fc';         }
    ...
    # (and so on)
                                                         ...
                                                         \s* (\") ((?:$qq_char)+?)             (\") /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_qq('',  $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                         \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                           { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1),$2)"; }
    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1),$2)"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest qw($1),";    }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest(qw($1),$2)"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_qq('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                           { $slash = 'm//'; return "Char::Egb18030::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1";                 }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "Char::Egb18030::$1(::"."$2)";        }
    elsif (/\G -(t)                            \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "-t $2";                     }
    elsif (/\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Egb18030::lstat';              }
    elsif (/\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Egb18030::stat';               }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egb18030::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egb18030::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::fc_';               }
    elsif (/\G \b lstat \b         (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::lstat_';            }
    elsif (/\G \b stat \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::stat_';             }
    elsif (/\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                     \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return "Char::Egb18030::filetest_(qw($1))"; }
    elsif (/\G    -([rwxoRWXOezsfdlpSbcugkTBMAC])
                     \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return "Char::Egb18030::${1}_";             }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::glob_';             }
    elsif (/\G \b reverse \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_reverse;          }
    elsif (/\G \b getc \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_getc;             }
    elsif (/\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Egb18030::opendir$1*";        }
    elsif (/\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Egb18030::opendir$1*";        }
    elsif (/\G \b unlink \b        (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egb18030::unlink';            }

# chdir
    elsif (/\G \b (chdir) \b       (?! \s* => ) /oxgc) {
        $slash = 'm//';

        my $e = 'Char::Egb18030::chdir';
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Egb18030::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Egb18030::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Egb18030::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Egb18030::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Egb18030::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Egb18030::split' . $e . qq     {" "};  }
...
# do
    ...
    elsif (/\G \b do (?= \s+ (?: q | qq | qx ) \b)                                    /oxmsgc) { return 'Char::Egb18030::do';         }
    elsif (/\G \b do (?= \s+ \w+)                                                     /oxmsgc) { return 'do';                }
    elsif (/\G \b do (?= \s* \$ \w+ (?: ::\w+)* \( )                                  /oxmsgc) { return 'do';                }
    elsif (/\G \b do \b                                                               /oxmsgc) { return 'Char::Egb18030::do';         }
...
# require else
    elsif (/\G \b require                                   \s* ;                     /oxmsgc) { return 'Char::Egb18030::require;';   }
    elsif (/\G \b require \b                                                          /oxmsgc) { return 'Char::Egb18030::require';    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Egb18030::PREMATCH()]}
            ...
            $e_string .= q{Char::Egb18030::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Egb18030::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Egb18030::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Egb18030::POSTMATCH()]}
            ...
            $e_string .= q{Char::Egb18030::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Egb18030
        ...
        elsif ($string =~ /\G \b Char::GB18030::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::GB18030::eval \b                                /oxgc) { $e_string .= 'eval Char::GB18030::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Egb18030::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::GB18030::index \b                               /oxgc) { $e_string .= 'Char::GB18030::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Egb18030::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::GB18030::rindex \b                              /oxgc) { $e_string .= 'Char::GB18030::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Egb18030::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egb18030::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egb18030::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egb18030::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egb18030::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egb18030::fc';         $slash = 'm//'; }
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\") ((?:$qq_char)+?)             (\") /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                                          { $e_string .= "Char::Egb18030::filetest(qw($1),$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1),$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $e_string .= "Char::Egb18030::filetest qw($1),";    $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $e_string .= "Char::Egb18030::filetest(qw($1),$2)"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $e_string .= "Char::Egb18030::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                                          { $e_string .= "Char::Egb18030::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $e_string .= "Char::Egb18030::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $e_string .= "Char::Egb18030::$1";          $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $e_string .= "Char::Egb18030::$1(::"."$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G -(t)                            \s+ (\w+)                                            /oxgc) { $e_string .= "-t $2";              $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Egb18030::lstat';       $slash = 'm//'; }
        elsif ($string =~ /\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Egb18030::stat';        $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egb18030::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egb18030::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Egb18030::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Egb18030::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Egb18030::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Egb18030::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Egb18030::fc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat \b                                           /oxgc) { $e_string .= 'Char::Egb18030::lstat_';            $slash = 'm//'; }
        elsif ($string =~ /\G \b stat \b                                            /oxgc) { $e_string .= 'Char::Egb18030::stat_';             $slash = 'm//'; }
        elsif ($string =~ /\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                 \b                 /oxgc) { $e_string .= "Char::Egb18030::filetest_(qw($1))"; $slash = 'm//'; }
        elsif ($string =~ /\G    -([rwxoRWXOezsfdlpSbcugkTBMAC]) \b                 /oxgc) { $e_string .= "Char::Egb18030::${1}_";             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Egb18030::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Egb18030::glob_';             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Egb18030::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Egb18030::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b unlink \b                                          /oxgc) { $e_string .= 'Char::Egb18030::unlink';            $slash = 'm//'; }

# chdir
        elsif ($string =~ /\G \b (chdir) \b (?! \s* => ) /oxgc) {
            $slash = 'm//';

            $e_string .= 'Char::Egb18030::chdir';
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Egb18030::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Egb18030::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Egb18030::dot_s}';
        }
        else {
            return '${Char::Egb18030::dot}';
        }
    }
    else {
        return Char::Egb18030::classic_character_class($char);
    }
}
...
sub e_capture {
    ...
    return join '', '${Char::Egb18030::capture(', $_[0], ')}';
    return join '', '${',                $_[0],  '}';
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Egb18030::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Egb18030::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Egb18030::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Egb18030::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Egb18030::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Egb18030::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Egb18030::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Egb18030::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Egb18030::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Egb18030::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Egb18030::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Egb18030::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Egb18030::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Egb18030::uc($char[$i]) ne Char::Egb18030::fc($char[$i]))) {
            if (CORE::length(Char::Egb18030::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Egb18030::uc($char[$i])       . Char::Egb18030::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Egb18030::uc($char[$i]) . '|' . Char::Egb18030::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egb18030::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Egb18030::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egb18030::ignorecase(Char::Egb18030::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Egb18030::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Egb18030::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egb18030::ignorecase(Char::Egb18030::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Egb18030::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Egb18030::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egb18030::ignorecase(Char::Egb18030::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Egb18030::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Char::GB18030::re_t=%s; local $Char::GB18030::re_a=''; while($Char::GB18030::re_t =~ %s){%s local $^W=0; local $Char::GB18030::re_r=%s; %s$Char::GB18030::re_t="$Char::GB18030::re_a${1}$Char::GB18030::re_r$'"; pos($Char::GB18030::re_t)=length "$Char::GB18030::re_a${1}$Char::GB18030::re_r"; $Char::GB18030::re_a=substr($Char::GB18030::re_t,0,pos($Char::GB18030::re_t)); } return $Char::GB18030::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::GB18030::re_r=CORE::eval $Char::GB18030::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::GB18030::re_t=%s; while($Char::GB18030::re_t =~ %s){%s local $^W=0; local $Char::GB18030::re_r=%s; %s$Char::GB18030::re_t="$`$Char::GB18030::re_r$'"; pos($Char::GB18030::re_t)=length "$`$Char::GB18030::re_r"; } return $Char::GB18030::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::GB18030::re_r=%s; %s"%s$Char::GB18030::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Char::GB18030::re_n=0; local $Char::GB18030::re_a=''; while(%s =~ %s){%s local $^W=0; local $Char::GB18030::re_r=%s; %s%s="$Char::GB18030::re_a${1}$Char::GB18030::re_r$'"; pos(%s)=length "$Char::GB18030::re_a${1}$Char::GB18030::re_r"; $Char::GB18030::re_a=substr(%s,0,pos(%s)); $Char::GB18030::re_n++} return %s$Char::GB18030::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::GB18030::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::GB18030::re_r=%s; %s%s="$`$Char::GB18030::re_r$'"; pos(%s)=length "$`$Char::GB18030::re_r"; $Char::GB18030::re_n++} return %s$Char::GB18030::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::GB18030::re_r=%s; %s%s="%s$Char::GB18030::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::GB18030::re_r=%s; %s%s="%s$Char::GB18030::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::GB18030::re_r=CORE::eval $Char::GB18030::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_chdir {
    ...
    if ($^W) {
        if (Char::Egb18030::_MSWin32_5Cended_path($string)) {
            if ($] !~ /^5\.005/) {
                warn <<END;
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egb18030::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Egb18030::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Egb18030::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
sub e_use_noimport {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Egb18030::_open_r($fh, $realfilename)) {
            local $/ = undef; # slurp mode
            my $script = <$fh>;
            close($fh) or die __FILE__, ": Can't close file: $realfilename";

            if ($script =~ /^ \s* use \s+ Char::GB18030 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq<BEGIN { Char::Egb18030::require '$expr'; }>;
            }
            last;
        }
    }
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Egb18030::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::GB18030 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                ...
                return qq[BEGIN { Char::Egb18030::require '$expr'; $module->import() if $module->can('import'); }];
            }
            last;
        }
    }
...
sub e_no_noparam {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Egb18030::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::GB18030 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Egb18030::require '$expr'; $module->unimport() if $module->can('unimport'); }];
            }
            last;
        }
    }
...
sub e_use {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Egb18030::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::GB18030 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Egb18030::require '$expr'; $module->import($list) if $module->can('import'); }];
            }
            last;
        }
    }
...
sub e_no {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Egb18030::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::GB18030 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Egb18030::require '$expr'; $module->unimport($list) if $module->can('unimport'); }];
            }
            last;
        }
    }
...
=head1 SYNOPSIS
  ...
  use Char::Egb18030;
    ...
    Char::Egb18030::chop(...);
    Char::Egb18030::index(...);
    Char::Egb18030::rindex(...);
    Char::Egb18030::lc(...);
    Char::Egb18030::lc_;
    Char::Egb18030::lcfirst(...);
    Char::Egb18030::lcfirst_;
    Char::Egb18030::uc(...);
    Char::Egb18030::uc_;
    Char::Egb18030::ucfirst(...);
    Char::Egb18030::ucfirst_;
    Char::Egb18030::fc(...);
    Char::Egb18030::fc_;
    Char::Egb18030::ignorecase(...);
    Char::Egb18030::capture(...);
    Char::Egb18030::chr(...);
    Char::Egb18030::chr_;
    Char::Egb18030::X ...;
    Char::Egb18030::X_;
    ...
    Char::Egb18030::glob_;
    Char::Egb18030::lstat(...);
    Char::Egb18030::lstat_;
    Char::Egb18030::opendir(...);
    Char::Egb18030::stat(...);
    Char::Egb18030::stat_;
    Char::Egb18030::unlink(...);
    Char::Egb18030::chdir(...);
    Char::Egb18030::do(...);
    Char::Egb18030::require(...);
    Char::Egb18030::telldir(...);

  # "no Char::Egb18030;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::GB18030 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::GB18030 software and not
...
This Char::Egb18030 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Egb18030::split(/pattern/,$string,$limit);
  @split = Char::Egb18030::split(/pattern/,$string);
  @split = Char::Egb18030::split(/pattern/);
  @split = Char::Egb18030::split('',$string,$limit);
  @split = Char::Egb18030::split('',$string);
  @split = Char::Egb18030::split('');
  @split = Char::Egb18030::split();
  @split = Char::Egb18030::split;
  ...
  at all, Char::Egb18030::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Egb18030::split(//,  $word);
  @fields = Char::Egb18030::split(/:/, $line);
  @words  = Char::Egb18030::split(" ", $paragraph);
  @lines  = Char::Egb18030::split(/^/, $buffer);
  ...
  print join(":" => Char::Egb18030::split(/ */, "hi there"));
  ...
  Char::Egb18030::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Egb18030::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Egb18030::split with no arguments does. Thus,
  Char::Egb18030::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Egb18030::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Egb18030::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Egb18030::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Egb18030::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Egb18030::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Egb18030::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Egb18030::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  print Char::Egb18030::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Egb18030::chop(@list);
  $chop = Char::Egb18030::chop();
  $chop = Char::Egb18030::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Egb18030::chop subroutine is used primary to remove the newline
  ...
  since Char::Egb18030::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Egb18030::chop a literal, only a variable. If you Char::Egb18030::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Egb18030::chop(@lines);

  You can Char::Egb18030::chop anything that is an lvalue, including an assignment:

  Char::Egb18030::chop($cwd = `pwd`);
  Char::Egb18030::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Egb18030::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Egb18030::chop returns the character
  ...
  In the most general case, Char::Egb18030::chop can be expressed using substr:

  $last_code = Char::Egb18030::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Egb18030::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Egb18030::chop;
...
=item Index string
  ...
  $byte_pos = Char::Egb18030::index($string,$substr,$byte_offset);
  $byte_pos = Char::Egb18030::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Egb18030::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Egb18030::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Egb18030::rindex($string,$substr);

  This subroutine works just like Char::Egb18030::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Egb18030::index).
  ...
  while (($byte_pos = Char::GB18030::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Char::Egb18030::lc($string);
  $lc = Char::Egb18030::lc_;
  ...
  You can use the Char::Egb18030::fc subroutine for case-insensitive comparisons via Char::GB18030
  software.

=item Lower case first character of string

  $lcfirst = Char::Egb18030::lcfirst($string);
  $lcfirst = Char::Egb18030::lcfirst_;
...
=item Upper case string
  ...
  $uc = Char::Egb18030::uc($string);
  $uc = Char::Egb18030::uc_;
  ...
  in interpolated strings. For titlecase, use Char::Egb18030::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Egb18030::ucfirst($string);
  $ucfirst = Char::Egb18030::ucfirst_;
  ...
  $titlecase = Char::Egb18030::ucfirst(substr($word,0,1)) . Char::Egb18030::lc(substr($word,1));
  ...
  $do_not_use = Char::Egb18030::ucfirst(Char::Egb18030::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Egb18030::fc($string);
  $fc = Char::Egb18030::fc_;

  New to Char::GB18030 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Egb18030::fc($a) eq Char::Egb18030::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::GB18030 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Egb18030::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Egb18030::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Egb18030::chr($code);
  $chr = Char::Egb18030::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Egb18030::chr(65) is "A" in either
  ASCII or GB18030, not Unicode. For the reverse of Char::Egb18030::chr, use Char::GB18030::ord.

=item File test subroutine Char::Egb18030::X
  ...
  \377 in the first block is considered a binary file. If Char::Egb18030::T or Char::Egb18030::B is
  used on a filehandle, the current input (standard I/O or "stdio") buffer is
  examined rather than the first block of the file. Both Char::Egb18030::T and Char::Egb18030::B
  return 1 as true on an empty file, or on a file at EOF (end-of-file) when testing
  a filehandle. Both Char::Egb18030::T and Char::Egb18030::B doesn't work when given the special
  filehandle consisting of a solitary underline. Because Char::Egb18030::T has to read to
  do the test, you don't want to use Char::Egb18030::T on special files that might hang or
  give you other kinds or grief. So on most occasions you'll want to test with a
  Char::Egb18030::f first, as in:
  ...
  next unless Char::Egb18030::M($file) > 0.5;     # files are older than 12 hours
...
=item Filename expansion (globbing)
  ...
  @glob = Char::Egb18030::glob($string);
  ...
  The Char::Egb18030::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Egb18030::glob('"*e f*"');
  @spacies = Char::Egb18030::glob(q("*e f*"));
...
=item Statistics about link
  ...
  @lstat = Char::Egb18030::lstat($file);
  @lstat = Char::Egb18030::lstat_;

  Like Char::Egb18030::stat, returns information on file, except that if file is a symbolic
...
=item Open directory handle
  ...
  $rc = Char::Egb18030::opendir(DIR,$dir);
...
=item Statistics about file
  ...
  $stat = Char::Egb18030::stat(FILEHANDLE);
  $stat = Char::Egb18030::stat(DIRHANDLE);
  $stat = Char::Egb18030::stat($expr);
  $stat = Char::Egb18030::stat_;
  @stat = Char::Egb18030::stat(FILEHANDLE);
  @stat = Char::Egb18030::stat(DIRHANDLE);
  @stat = Char::Egb18030::stat($expr);
  @stat = Char::Egb18030::stat_;
  ...
  ($dev,$ino,$mode,$nlink,$uid,$gid,$rdev,$size,
      $atime,$mtime,$ctime,$blksize,$blocks) = Char::Egb18030::stat($expr);
  ...
  If Char::Egb18030::stat is passed the special filehandle consisting of an underline, no
  actual stat(2) is done, but the current contents of the stat structure from
  the last Char::Egb18030::stat, Char::Egb18030::lstat, or Char::Egb18030::stat-based file test subroutine
  (such as Char::Egb18030::r, Char::Egb18030::w, and Char::Egb18030::x) are returned.
  ...
  $mode = (Char::Egb18030::stat($expr))[2];
...
=item Deletes a list of files.
  ...
  $unlink = Char::Egb18030::unlink(@list);
  $unlink = Char::Egb18030::unlink($file);
  $unlink = Char::Egb18030::unlink;
...
=item Changes the working directory.
  ...
  $chdir = Char::Egb18030::chdir($dirname);
  $chdir = Char::Egb18030::chdir;
...
=item Do file
  ...
  Char::Egb18030::do('stat.pl');

  is rather like: 

  scalar CORE::eval `cat stat.pl`;   # `type stat.pl` on Windows

  except that Char::Egb18030::do is more efficient, more concise, keeps track of the current
  filename for error messages, searches all the directories listed in the @INC
  array, and updates %INC if the file is found.
  It also differs in that code evaluated with Char::Egb18030::do FILE can not see lexicals in
  ...
  If Char::Egb18030::do can't read the file, it returns undef and sets $! to the error. If 
  Char::Egb18030::do can read the file but can't compile it, it returns undef and sets an
  ...
  with the use and require operators, which also Char::Egb18030::do error checking and raise
  ...
  But Char::Egb18030::do FILE is still useful for such things as reading program configuration
  files. Manual error checking can be done this way:

  # read in config files: system first, then user
  for $file ("/usr/share/proggie/defaults.rc", "$ENV{HOME}/.someprogrc") {
      unless ($return = Char::Egb18030::do($file)) {
          warn "couldn't parse $file: $@" if $@;
          warn "couldn't Char::Egb18030::do($file): $!" unless defined $return;
  ...
  Char::Egb18030::do to reload that file. This is more tidily accomplished with Char::Egb18030::do than
  with Char::Egb18030::require.

=item Require file

  Char::Egb18030::require($file);
  Char::Egb18030::require();

  This subroutine asserts a dependency of some kind on its argument. If an argument is
  not supplied, $_ is used.

  Char::Egb18030::require loads and executes the Perl code found in the separate file whose
  name is given by the $file. This is similar to using a Char::Egb18030::do on a file, except
  that Char::Egb18030::require checks to see whether the library file has been loaded already
  ...
  its cousins Char::Egb18030::do, Char::Egb18030::require knows how to search the include path stored
...
=item Current position of the readdir
  ...
  $telldir = Char::Egb18030::telldir(DIRHANDLE);
