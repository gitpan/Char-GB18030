...
This module is a run-time routines of the Char::GB18030 module.
Because the Char::GB18030 module automatically uses this module, you need not use directly.
...
=item current position of the readdir
  ...
  Char::Egb18030::telldir(DIRHANDLE);
