...
######################################################################
#
# Char::GB18030 - Source code filter to GB18030 script
#
...
sub Char::GB18030::escape_script {
    ...
    if (/^ use Char::Egb18030(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Egb18030 %s;\n%s", $Char::Egb18030::VERSION, $use_re_eval); # require run-time routines version
...
Char::GB18030 - Source code filter to escape GB18030

=head1 SYNOPSIS

  use Char::GB18030;
  use Char::GB18030 version;         --- require version
...
Regular expression works as character-oriented that has no /b modifier.
  ...
  m?regexp?               m?ditto@Char::Egb18030::matched?
  s/regexp/replacement/   ($_ =~ m/ditto@Char::Egb18030::matched/) ?
                          eval{ Char::Egb18030::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
...
Regular expression works as byte-oriented that has /b modifier.
  ...
  m?regexp?b              m?regexp@Char::Egb18030::matched?
  s/regexp/replacement/b  ($_ =~ m/(\G[\x00-\xFF]*?)(?:regexp)@Char::Egb18030::matched/) ?
                          eval{ Char::Egb18030::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
