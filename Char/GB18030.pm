...
=item * Possible to handle raw GB18030 values

=item * Backward compatibility of data, script and how to

=item * Only Char/GB18030.pm and Char/Egb18030.pm, other modules are unnecessary
...
Char/GB18030.pm remove 'bytes::' at head of function name.
...
Char/GB18030.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
oriented function. See 'CHARACTER ORIENTED FUNCTIONS'.
  ...
  index       Char::GB18030::index
  rindex      Char::GB18030::rindex
  ---------------------------------
