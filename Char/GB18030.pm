...
sub import {
    ...
    if (Char::Egb18030::e("$filename.e")) {
        if (exists $ENV{'SJIS_DEBUG'}) {
            ...
            my $mtime_filter = (Char::Egb18030::stat(__FILE__     ))[9];
            my $mtime_source = (Char::Egb18030::stat($filename    ))[9];
            my $mtime_escape = (Char::Egb18030::stat("$filename.e"))[9];
...
import of Char/Egb18030.pm works well.
...
=item * Returns Next Character
  ...
  If you import getc "use Char::GB18030 qw(getc);", getc of your script will be rewritten
  in Char::GB18030::getc. Char::GB18030::getc is not compatible with getc of JPerl.
...
=item * Length by GB18030 Character
  ...
  of the scalar value $string. If $string is omitted, it returns the Char::GB18030::length
  of $_.
...
=item * Substr by GB18030 Character
  ...
  If Perl version 5.14 or later, you can use the Char::GB18030::substr() subroutine as an
...
=item * Rindex by GB18030 Character
  ...
  This subroutine works just like Char::GB18030::index except that it returns the character
...
=item * Filename Globbing
  ...
  This operator is implemented via the Char::Egb18030::glob() subroutine. See Char::Egb18030::glob
  of Char/Egb18030.pm for details.
...
=head1 Un-Escaping bytes::* Subroutines (Char/GB18030.pm provides)

Char/GB18030.pm removes 'bytes::' at head of subroutine name.
...
If Perl version is older than 5.14, Char::GB18030::substr differs from CORE::substr, and
...
exist at time of be written this document and JPerl did exist.
                        ...
                        (a)     (b)     (c)     (d)     (e)
                                      JPerl,japerl    Encode,Char::GB18030
      +--------------+-------+-------+-------+-------+-------+
      | data         |  Old  |  Old  |  New  |  Old  |  New  |
      +--------------+-------+-------+-------+-------+-------+
      | script       |  Old  |      Old      |      New      |
