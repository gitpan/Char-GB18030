...
Let's start with a bit of history: jperl 4.019+1.3 introduced GB18030 support.
...
In this country, GB18030 is widely used on mainframe I/O, the personal computer,
and the cellular phone. This software treats GB18030 directly, but doesn't treat
...
Insert 'Char::Egb18030::' instead of '-' of operator.
  ...
  --------------------------------------------------------------------------
  -r       Char::Egb18030::r   File is readable by effective uid/gid
  -w       Char::Egb18030::w   File is writable by effective uid/gid
  -x       Char::Egb18030::x   File is executable by effective uid/gid
  -o       Char::Egb18030::o   File is owned by effective uid
  -R       Char::Egb18030::R   File is readable by real uid/gid
  -W       Char::Egb18030::W   File is writable by real uid/gid
  -X       Char::Egb18030::X   File is executable by real uid/gid
  -O       Char::Egb18030::O   File is owned by real uid
  -e       Char::Egb18030::e   File exists
  -z       Char::Egb18030::z   File has zero size
  -f       Char::Egb18030::f   File is a plain file
  -d       Char::Egb18030::d   File is a directory
  -l       Char::Egb18030::l   File is a symbolic link
  -p       Char::Egb18030::p   File is a named pipe (FIFO)
  -S       Char::Egb18030::S   File is a socket
  -b       Char::Egb18030::b   File is a block special file
  -c       Char::Egb18030::c   File is a character special file
  -t       -t         Filehandle is opened to a tty
  -u       Char::Egb18030::u   File has setuid bit set
  -g       Char::Egb18030::g   File has setgid bit set
  -k       Char::Egb18030::k   File has sticky bit set
  -T       Char::Egb18030::T   File is a text file
  -B       Char::Egb18030::B   File is a binary file (opposite of -T)
  -s       Char::Egb18030::s   File has nonzero size (returns size in bytes)
  -M       Char::Egb18030::M   Age of file (at startup) in days since modification
  -A       Char::Egb18030::A   Age of file (at startup) in days since last access
  -C       Char::Egb18030::C   Age of file (at startup) in days since inode change
  --------------------------------------------------------------------------
