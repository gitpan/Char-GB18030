...
10% everything else. But this "text" means US-ASCII text, and popular GB18030
...
Perl3 or later can treat GB18030.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::GB18030 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw GB18030, Doesn't use UTF8 flag like JPerl
...
It has already been achieved by GB18030 designed for combining with
...
Contrasting is Encode module and describing "use Char::GB18030;" on this software,
